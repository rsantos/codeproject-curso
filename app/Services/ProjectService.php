...
class ProjectService
{
	...
	public function __construct(ProjectRepository $repository, ProjectValidator $validator, ProjectMemberRepository $projectMemberRepository, ProjectMemberValidator $projectMemberValidator)
	{
